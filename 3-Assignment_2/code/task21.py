...
if __name__=="__main__":
    ...
    trainset = WARWICKDataset(root_dir="WARWICK", train=True, transform=transform, target_transform=transform)
    testset = WARWICKDataset(root_dir="WARWICK", train=False, transform=transform, target_transform=transform)
    ...
    # train the model
    loss_hist_dobn, tr_acc_hist_dobn, ts_acc_hist_dobn= train_warwick(model=modelSEGMENT, trainset=trainset, testset=testset, step_size=1e-4, epochs=25, minibatch_size=64)
    # print final summary
